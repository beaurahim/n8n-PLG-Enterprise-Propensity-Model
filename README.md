# n8n-PLG-Enterprise-Propensity-Model
...
Consumption & momentum: executions, execution growth, production usage.

Adoption breadth: active builders, workflows, departments, tenure.

Enterprise need / intent: SSO, Git/environments, log streaming, external secrets, pricing/security/enterprise-doc views.

Firmographic fit: employee count, industry, region, current plan.
